...
%prep
%setup -q
LIBPATH="%{aster_libs}scotch-5.1.11_esmumps/lib  %{aster_libs}metis-4.0.3/lib/ /usr/lib64/" INCLUDES="%{aster_libs}scotch-5.1.11_esmumps/include/ %{aster_libs}metis-4.0.3/include" ./waf configure --maths-libs="openblas" --embed-maths --install-tests --prefix=%{buildroot}%{_prefix}
