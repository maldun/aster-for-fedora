...
Name:           codeaster-testing-mumps-openmpi
Version:        %{version}
Release:        1%{?dist}
...
Source0:        codeaster-testing-mumps-openmpi-%{version}.tar.gz
Source1:        wscript-mumps-openmpi

Requires:	codeaster-testing-metis codeaster-testing-scotch codeaster-scalapack-openmpi
