...
QA_SKIP_BUILD_ROOT=1 rpmbuild -ba codeaster-stable.spec --define "major_version $ASTER_STABLE" --define "sub_version $ASTER_STABLE_SUB" --define "mfront_version $MFRONT_VER" --define "aster_libs $ASTER_LIBS" --define "aster_root $ASTER_BASE"
